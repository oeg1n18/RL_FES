...
class pipeline:
    ...
    def preprocess(self, input, output):
        ...
        self.Y_train = np.zeros((self.Y_train_full.shape[0], self.Y_train_full.shape[1]-1, self.Y_train_full.shape[2]))
        self.Y_valid = np.zeros((self.Y_valid_full.shape[0], self.Y_valid_full.shape[1]-1, self.Y_valid_full.shape[2]))
